 ...
 */
package com.adobe.assignment.core.models;
...
import com.adobe.assignment.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "event-management/components/helloworld");
